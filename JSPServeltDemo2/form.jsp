...
<body>
 <form action="GreetServlet" method="get" style="width: 350px; margin: 50px auto; padding: 30px; border: 3px solid #ccc; border-radius: 10px; background-color: #f9f9f9; font-family: Arial;">
